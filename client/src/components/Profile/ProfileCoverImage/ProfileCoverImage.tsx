...
export const ProfileCoverImage: React.FC<PropsTypes> = ({
  ...
  return (
    <div className={classes.coverImage}>
      ...
      <img className={classes.image} src={img || defaultCoverImage} alt="" />
    </div>
  );
};
