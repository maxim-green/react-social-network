...
export const Col: React.FC<ColProps> = ({
  ...
  <div
    className={classnames(classes.col, { [classes.bordered]: bordered })}
    style={{
      padding,
      marginRight: style?.marginRight,
      alignItems: horizontalAlign,
      justifyContent: verticalAlign || style?.justifyContent,
      flex: stretch ? 1 : undefined,
    }}
  >

    {React.Children.map(children, (child) => (
      <div className={classes.item} style={{ marginBottom: gap }}>
        {child}
      </div>
    ))}
  </div>
...
export const Space: React.FC = () => <div className={classes.space} />;
